...
const Finance = () => {
  const [records, setRecords] = useState<FinanceRecord[]>(getFinance());
    ...
    <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={form.type}
                    onValueChange={(v) =>
                      setForm({ ...form, type: v as FinanceRecord["type"], category: "" })
                    }
                  >
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <div className="p-5 rounded-xl bg-card border border-border">
          ...
          <p className={`text-xl font-bold font-display ${balance >= 0 ? "text-accent" : "text-destructive"}`}>
